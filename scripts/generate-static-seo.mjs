...
function staticVideoSection() {
  ...
  return `<section class="section static-video" id="how-it-works"><div class="wrap static-video-grid"><div><div class="static-browser"><div class="static-browser-bar"><span>BuildMyCVNow demo</span><a class="btn secondary" href="${HOME_VIDEO.url}" rel="noopener">Open video</a></div><a class="static-video-facade" href="${HOME_VIDEO.url}" rel="noopener" aria-label="Open BuildMyCVNow tutorial video"><img src="/assets/heygen-demo-poster.svg" width="960" height="540" loading="lazy" alt="BuildMyCVNow video poster showing a finished CV and play button"><span class="static-play-button">Play</span></a></div><div class="static-pills">${steps.map((step, index) => `<span class="static-pill">${index + 1}. ${step}</span>`).join("")}</div><div class="static-chapters">${chapters.map((chapter) => `<span class="chip">${chapter}</span>`).join("")}</div></div><div><div class="static-section-title" style="text-align:left;margin:0 0 22px"><h2>${HOME_VIDEO.title}</h2><p class="lead">${HOME_VIDEO.subtitle}</p></div><div class="static-step-list">${HOME_BUILD_STEPS.map((step, index) => `<div class="static-step"><strong>Step ${index + 1}</strong><br>${step}</div>`).join("")}</div><p class="muted"><strong>Tip:</strong> You can switch templates at any time without losing your data.</p><div class="static-stat-row"><div class="static-stat"><strong>5 min</strong>Average build</div><div class="static-stat"><strong>8+</strong>Job categories</div><div class="static-stat"><strong>100%</strong>Free PDF</div></div></div></div></section>`;
}
